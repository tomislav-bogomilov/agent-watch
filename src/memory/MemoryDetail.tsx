...
const styles = {
  ...
  act: { background: 'transparent', borderWidth: 1, borderStyle: 'solid' as const, borderColor: 'rgba(0,229,255,0.4)', color: 'var(--text)', borderRadius: 3, padding: '3px 9px', cursor: 'pointer', fontSize: 11 },
  ...
  badge: { fontSize: 9, padding: '1px 6px', borderRadius: 8, borderWidth: 1, borderStyle: 'solid' as const, marginRight: 6, textTransform: 'uppercase' as const },
  ...
  pill: { display: 'inline-block', fontSize: 10, padding: '3px 8px', borderRadius: 10, borderWidth: 1, borderStyle: 'solid' as const, borderColor: 'rgba(0,229,255,0.4)', color: 'var(--edge-trail)', background: 'transparent', margin: '2px 4px 2px 0', cursor: 'pointer' },
